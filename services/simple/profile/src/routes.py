...
def get_patients():
    try:
        ...
        return jsonify({"message": "An error occurred retrieving the patients."}), 400
...
def get_patient_by_id(patientID):
    try:
        ...
        traceback.print_exception(type(e), e, e.__traceback__)
        return jsonify({"message": "An error occurred retrieving the patient."}), 400
...
def edit_patient_profile(patientID):
    try:
        ...
        traceback.print_exception(type(e), e, e.__traceback__)
        return jsonify({"message": "An error occurred updating the patient profile."}), 500
...
def add_patient_profile():
    try:
        ...
        traceback.print_exception(type(e), e, e.__traceback__)
        return jsonify({"message": "An error occurred creating the patient profile."}), 500
...
def get_doctors():
    try:
        ...
        traceback.print_exception(type(e), e, e.__traceback__)
        return jsonify({"message": "An error occurred retrieving the doctors."}), 400
...
def edit_doctor_profile(doctorID):
    try:
        ...
        traceback.print_exception(type(e), e, e.__traceback__)
        return jsonify({"message": "An error occurred updating the doctor profile."}), 500
